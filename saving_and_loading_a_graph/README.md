...
1. Open a Windows command line and activate an environment. Type 'code' to open Code, then browse to the saving_and_loading_a_graph directory. Open main.py.
...
To run the main.py script, browse to saving_and_loading_a_graph directory and run the following command in a command line window:
