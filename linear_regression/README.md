...
In this project, I show you how to use TensorFlow to effect linear regression.
...
1. Open a Windows command line and activate an environment. Type 'code' to open Code, then browse to the linear_regression directory. Open main.py.
