...
training_features_dir = input_dir + 'training/features/'
training_labels_dir = input_dir + 'training/labels/'
validation_features_dir = input_dir + 'validation/features/'
validation_labels_dir = input_dir + 'validation/labels/'
